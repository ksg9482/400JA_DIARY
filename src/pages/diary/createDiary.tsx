...
const CreateDiary = (props: any) => {
    ...
    const defaultInputHandler = (key: string, e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    //key 값으로 구분해서 작동
    return (
        <form className="border flex flex-col w-full px-5 max-w-screen-lg" onSubmit={submitHandle}>
            <textarea id="diaryInputSubject"
                className="border"
